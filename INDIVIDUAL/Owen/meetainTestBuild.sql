...
CREATE TABLE IF NOT EXISTS achievement (									-- :::::徽章::::: 
    ...
    `achievement_image` 	varchar(200)	not null						-- 成就圖片
) ;
...
CREATE TABLE IF NOT EXISTS member (											-- :::::會員::::: 
    ...
    `mem_acc` 				varchar (12) 	not null unique,				-- 會員帳號 
	...
	`mem_avator`			Varchar(200)	,								-- 會員大頭貼位子
	`mem_bg`				Varchar(200)	,								-- 會員背景圖片位子
    `mem_badge1`			int				,								-- 徽章秀1
    `mem_badge2`			int				,								-- 徽章秀2
    `mem_badge3`			int				,								-- 徽章秀3
...
CREATE TABLE IF NOT EXISTS product (											-- :::::商城商品::::: 
    ...
    `product_image` 			varchar(200)	not null,						-- 商品圖
...
CREATE TABLE IF NOT EXISTS tour (											-- :::::揪團::::: 
    ...
    `tour_sitiuation` 		varchar(30)		not null default'報名中',		-- 揪團狀態 報名中/已截止/已結束/取消/延期
    ...
    `tour_innertext` 		varchar(12000)	not null,						-- 揪團文內文
    `tour_equip_1` 			varchar(30)		,								-- 裝備要求1
    `tour_equip_2` 			varchar(30)		,								-- 裝備要求2
    `tour_equip_3` 			varchar(30)		,								-- 裝備要求3
    `tour_equip_4` 			varchar(30)		,								-- 裝備要求4
    `tour_equip_5` 			varchar(30)		,								-- 裝備要求5
...
CREATE TABLE IF NOT EXISTS forum_post (										-- :::::討論::::: 
    ...
    `forum_post_category` 	varchar(30)		not null,						-- 討論文類別		
    `forum_post_image` 		varchar(200)	not null,						-- 討論文圖片
...
CREATE TABLE IF NOT EXISTS comment_post (									-- :::::留言::::: 
    ...
    `forum_post_no` 		int				not null,						-- 討論文編號		
...
CREATE TABLE IF NOT EXISTS comment_report (										-- :::::留言檢舉::::: 
    ...
    foreign key (`comment_report_comment`) references forum_post(`forum_post_no`) on delete cascade on update cascade
);
...
CREATE TABLE IF NOT EXISTS order_list (										-- :::::會員追蹤::::: 
...
CREATE TABLE IF NOT EXISTS administrator (									-- :::::管理員::::: 
    ...
    `admin_acc` 			varchar(12)		not null unique,				-- 管理員帳號		
